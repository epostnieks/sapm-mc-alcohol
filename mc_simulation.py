#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Alcohol / Prohibition Paradox
=============================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Alcohol (Prohibition Paradox).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "alcohol",
    "domain_name": "Alcohol",
    "theorem": "Prohibition Paradox",
    "classification": "Class 2 \u2014 Intractability",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 85.0,
    "channels": {
        "C1_mortality_morbidity": {
            ...
            "high": 1500,
            "weight": 0.3,
            "description": "3M deaths/yr, VSL-adjusted plus morbidity burden"
        },
        "C2_organ_damage_cancer": {
            ...
            "high": 190,
            "weight": 0.2,
            "description": "Liver disease, cancer treatment, chronic conditions"
        },
        "C3_violence_traffic": {
            "dist": "lognormal",
            "low": 140,
            ...
            "high": 230,
            "weight": 0.18,
            "description": "DUI fatalities, domestic violence, assault"
        },
        "C4_addiction_family": {
            "dist": "lognormal",
            "low": 45,
            ...
            "high": 95,
            "weight": 0.15,
            "description": "AUD treatment, family destruction, child welfare"
        },
        "C5_productivity": {
            "dist": "normal",
            "low": 400,
            ...
            "high": 800,
            "weight": 0.12,
            "description": "Absenteeism, presenteeism, lost human capital"
        },
        "C6_governance": {
            "dist": "lognormal",
            "low": 15,
            ...
            "high": 40,
            "weight": 0.05,
            "description": "Industry lobbying, regulatory capture, marketing to youth"
        }
    },
